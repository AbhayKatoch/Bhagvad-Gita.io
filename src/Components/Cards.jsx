...
function Cards({ chap }) {
  ...
  if (!data) {
    return (
      <>
        <div>
          <div class="relative font-serif flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 animate-pulse">
            <div class="p-6">
    ...
    <>
      <div>
        <div class="relative font-serif flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
          <div class="p-6">
            <h6 class="block  font-sans mb-2 text-lg antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
